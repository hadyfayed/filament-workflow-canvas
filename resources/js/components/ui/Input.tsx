        ...
        <div className="relative">
          {leftIcon && (
            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
              <div className="w-5 h-5 text-gray-400 dark:text-gray-500">{leftIcon}</div>
            </div>
          )}
          ...
          {rightIcon && (
            <div className="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
              <div className="w-5 h-5 text-gray-400 dark:text-gray-500">{rightIcon}</div>
            </div>
          )}
        </div>

        {(helperText || errorText) && (
          <p id={hasError ? `${inputId}-error` : `${inputId}-help`} className={helperTextClasses}>
