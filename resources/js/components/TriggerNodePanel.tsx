...
export const TriggerNodePanel: FC<TriggerNodePanelProps> = ({ config, updateConfig }) => {
    ...
    return (
        <div className="space-y-4">
            <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Trigger Type</label>
                <select
            ...
            {config.trigger_type === 'event' && (
                <div className="space-y-3 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                    ...
                    {config.event_type === 'custom' && (
                        <div>
                            <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Custom Event Name</label>
                            <input
                                type="text"
            ...
            {config.trigger_type === 'webhook' && (
                <div className="space-y-3 p-4 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800">
                    ...
                    <div>
                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">HTTP Method</label>
                        <select
            ...
            {config.trigger_type === 'schedule' && (
                <div className="space-y-3 p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg border border-purple-200 dark:border-purple-800">
                    <h4 className="font-medium text-purple-900 dark:text-purple-100">Schedule Configuration</h4>
                    
                    <div>
                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Schedule Type</label>
                        <select
                    ...
                    {config.schedule_type === 'cron' && (
                        <div>
                            <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Cron Expression</label>
                            <input
                                type="text"
                    ...
                    {config.schedule_type === 'interval' && (
                        <div>
                            <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Interval</label>
                            <select
            ...
            {config.trigger_type === 'api' && (
                <div className="space-y-3 p-4 bg-orange-50 dark:bg-orange-900/20 rounded-lg border border-orange-200 dark:border-orange-800">
                    ...
                    <div>
                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">API Endpoint</label>
                        <input
                            type="text"
                    ...
                    <div className="flex items-center">
                        ...
                        />
                        <label htmlFor="require_auth" className="ml-2 block text-sm text-gray-700 dark:text-gray-200">
            ...
            {config.trigger_type === 'manual' && (
                <div className="space-y-3 p-4 bg-gray-50 dark:bg-gray-800/50 rounded-lg border border-gray-200 dark:border-gray-700">
                    ...
                    <div>
                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Who can trigger manually?</label>
                        <select
                    ...
                    <div className="flex items-center">
                        <input
                            ...
                            className="h-4 w-4 text-primary-600 focus:ring-primary-500 border-gray-300 rounded"
                        />
                        <label htmlFor="manual_confirmation" className="ml-2 block text-sm text-gray-700 dark:text-gray-200">
            ...
            <div className="border-t border-gray-200 dark:border-gray-700 pt-4">
                 <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-2">Data Filters</label>
                    ...
                    {filters.map((filter, index) => (
                        <div key={index} className="p-3 bg-gray-50 dark:bg-gray-800/50 rounded-md border border-gray-200 dark:border-gray-700 space-y-2">
                            <div className="flex justify-between items-center">
                                <p className="text-sm font-medium text-gray-600 dark:text-gray-300">Filter #{index + 1}</p>
                                <button onClick={() => removeFilter(index)} className="text-gray-400 hover:text-red-500 dark:hover:text-red-400">
