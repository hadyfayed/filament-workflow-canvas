...
const DRIVERS = ['ga4', 'meta_pixel', 'mixpanel', 'snapchat', 'tiktok', 'adobe_analytics', 'moengage'];
...
export const AnalyticsNodePanel: FC<AnalyticsNodePanelProps> = ({ config, updateConfig }) => {
    ...
    return (
        <div className="space-y-4">
            <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Analytics Driver</label>
                <select
                    value={config.driver || ''}
            ...
            <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Event Name Mapping</label>
                <input
                    type="text"
            ...
            <div className="border-t border-gray-200 dark:border-gray-700 pt-4">
                 <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-2">Data Transform Rules</label>
                    ...
                    {rules.map((rule, index) => (
                        <div key={index} className="p-3 bg-gray-50 dark:bg-gray-800/50 rounded-md border border-gray-200 dark:border-gray-700 space-y-2">
                            <div className="flex justify-between items-center">
                                <p className="text-sm font-medium text-gray-600 dark:text-gray-300">Rule #{index + 1}</p>
                                <button onClick={() => removeRule(index)} className="text-gray-400 hover:text-red-500 dark:hover:text-red-400">
