  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        />
        <p id={`node-label-${nodeId}-help`} className="mt-1 text-xs text-gray-500 dark:text-gray-400">
      ...
      <div>
        ...
        />
        <p id={`node-description-${nodeId}-help`} className="mt-1 text-xs text-gray-500 dark:text-gray-400">
